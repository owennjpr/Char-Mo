...
function Documentation() {
  ...
  return (
    <div className="w-full flex flex-col items-center py-8 font-cutive gap-4">
      <Txt
        enter={{
          type: "randomized",
...
<Txt enter={{ type: "typed sweep" }}>
  Hello World!
        ...
        <p className="text-base pt-4">
          ...
          classes/styles/etc. that can be applied to a paragraph element can be
          applied directly.
        </p>
        <p className="bg-[#0003] p-4 text-base whitespace-pre-wrap overflow-x-scroll">
          {`<Txt 
...
>
  ...
  eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <p className="text-base pt-4">
          You can apply multiple different categories of effects on the same Txt
          component, for example having both a hover and an enter effect.
        </p>
        <p className="bg-[#0003] p-4 text-base whitespace-pre-wrap overflow-x-scroll">
          {`<Txt
  enter={{
