...
function Gallery() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-4 justify-center items-center font-cutive">
      <Txt
        enter={{
          type: "randomized",
 ...
 |______|_| |_| \\___|\\___|\\__|  \\_____|\\__,_|_|_|\\___|_|   \\__, |
      ...
      >
        check out each of the effects in this library, as well as copy-and
        -pasteable components if there is an individual effect you want to
        modify and use in your project!
      </Txt>
      ...
      <div className="flex flex-row w-1/2 justify-around">
        <div className="">
          ...
          <div className="text-base pl-4">
            <LinkButton key={"2step" + refresh} path="/gallery/enter_random">
